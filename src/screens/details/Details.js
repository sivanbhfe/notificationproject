...
class Details extends Component {
		...
		return (
			<div>
				...
				<FormControl >
					...
					<Input className="inputtitle" onChange={this.titleUpdate} style={{Width:"100%",fontWeight:"bolder"}} id="title" />
				</FormControl><br/>
				<FormControl  >
				...
				<FormControl>
					...
					<Input className="inputfields" id="starttime" onChange={this.starttimeupdate}	
					/>
				</FormControl>
				<FormControl>
					<InputLabel  htmlFor="endtime">End time</InputLabel>
					<Input className="inputfields" id="endtime" onChange={this.endtimeupdate}	
					/>
				</FormControl>
				<FormControl>
	...
	<tr id="tableticket">
		...
		<td>{this.state.starttime}<span> to </span>{this.state.endtime}</td></tr>
